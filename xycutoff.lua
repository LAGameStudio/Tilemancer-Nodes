...
-- note, if you change the size of the tile globally, you must delete and replace this node since i'm not sure how to update parameter max values
  addParameter("X", "The amount of pixels to cutoff by in the X axis", 108+16, 0, 0, getTileSize())
  addParameter("Y", "The amount of pixels to cutoff by in the Y axis", 108+32, 0, 0, getTileSize())
...
function apply()
  size = getTileSize()
  xCutoff = getValue(2, 0, 0, 1)
  yCutoff = getValue(3, 0, 0, 1)
