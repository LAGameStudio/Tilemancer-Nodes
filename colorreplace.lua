...
function init()
    ...
    addOutput(24+32)
    addTexture("Texture", 24+64+16)
    addParameter("Fuzziness", "How far off a color can be to match", 108+16, 0, 0, 100,true)
    addParameter("R", "Match", 108+16, 1, 1, 100,true)
    addParameter("G", "Match", 108+32, 1, 1, 100,true)
    addParameter("B", "Match", 108+48, 1, 1, 100,true)
    addParameter("to R", "How far off a color can be to match", 108+64, 1, 1, 100,true)
    addParameter("   G", "How far off a color can be to match", 108+80, 1, 1, 100,true)
    addParameter("   B", "How far off a color can be to match", 108+96, 1, 1, 100,true)
end
